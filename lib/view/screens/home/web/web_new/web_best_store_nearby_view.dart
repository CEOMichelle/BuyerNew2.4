    ...
    return Container(
      ...
      child: Column(children: [
        ...
        isPharmacy ? Padding(
          ...
          padding: const EdgeInsets.only(right: Dimensions.paddingSizeSmall, left: Dimensions.paddingSizeDefault, top: Dimensions.paddingSizeSmall, bottom: Dimensions.paddingSizeSmall),
          child: Row(children: [
            ...
            Icon(Icons.arrow_forward, size: 20, color: Theme.of(context).primaryColor.withOpacity(0.2)),
            const Spacer(),
        ...
        Stack(children: [
          GetBuilder<StoreController>(builder: (storeController) {
            ...
            return SizedBox(
              ...
              child: storeList != null && storeList.isNotEmpty ? Row(
                children: [
                  !isPharmacy ? const SizedBox(width: Dimensions.paddingSizeDefault) : const SizedBox(),
                  !isPharmacy ? RotatedBox(
                    quarterTurns: 3,
                    child: Padding(
                      padding: EdgeInsets.only(bottom: Get.find<LocalizationController>().isLtr ? Dimensions.paddingSizeDefault : 0),
          ...
          if(showBackButton)
            Positioned(
              top: 60, left: isPharmacy ? 0 : Get.find<LocalizationController>().isLtr ? 45 : 0,
          ...
          if(showForwardButton)
            Positioned(
              top: 60, right: Get.find<LocalizationController>().isLtr ? 0 : 45,
              child: ArrowIconButton(
                onTap: () => scrollController.animateTo(scrollController.offset + Dimensions.webMaxWidth,
                    duration: const Duration(milliseconds: 500), curve: Curves.easeInOut),
              ),
