                      ...
                      Container(
                        ...
                        child: SizedBox(
                          ...
                          child: (widget.fromShop
                                  ...
                                  : itemController.basicMedicineModel != null)
                              ? GridView.builder(
                                gridDelegate: const  SliverGridDelegateWithFixedCrossAxisCount(crossAxisCount: 2, mainAxisSpacing: Dimensions.paddingSizeDefault),
...
//             Container(
//               decoration: BoxDecoration(
//                 color: Colors.red/* widget.fromShop ? Theme.of(context).disabledColor.withOpacity(0.1) : Theme.of(context).primaryColor.withOpacity(0.1) */,
//               ),
//               // padding: const EdgeInsets.only(top: 40),
//               child: SizedBox(
